...
void SendSMS()
{
  ...
  SWserial.println("AT+CMGF=1\r");                   //Set the module to SMS mode
  delay(100);
  SWserial.println("AT+CMGS=\"+250781196048\"\r");  //Your phone number don't forget to include your country code, example +212123456789"
  delay(500);
  SWserial.println("Balance is low 15%");       //This is the text to send to the phone number, don't make it too long or you have to modify the SoftwareSerial buffer
  delay(500);
  SWserial.println((char)26);// (required according to the datasheet)
  ...
  delay(500); 
  SWserial.println("Sending 2nd SMS...");               //Show this message on serial monitor
  sim800l.print("AT+CMGF=1\r");                   //Set the module to SMS mode
  delay(100);
  SWserial.println("AT+CMGS=\"+250788856865\"\r");  //Your phone number don't forget to include your country code, example +212123456789"
  delay(500);
  SWserial.println("Balance is low 15%");       //This is the text to send to the phone number, don't make it too long or you have to modify the SoftwareSerial buffer
  delay(500);
  SWserial.println((char)26);// (required according to the datasheet)
